...
require (
	...
	github.com/gardener/gardener-extension-provider-openstack v1.37.1
...
replace (
	github.com/gardener/gardener => github.com/kon-angelo/gardener v1.9.1-0.20231108211259-fa84b1807ffb
